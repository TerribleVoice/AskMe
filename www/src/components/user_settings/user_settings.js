                            ...
                            <form class="SettingsEdit_form_EEYht">
                                                    ...
                                                    <div class="CirclesAnimation_content_Dfcn9">
                                                        <div class="FileButton_container_S5fmr">
                                                            <label for="myFile" class="FileButton_label_wRR_W">
                                                                <input accept="image/*" class="FileButton_input__fX_o" id="myFile" name="photo" type="file" />
                                ...
                                <div class="Form_standard_f_1gD">
                                    ...
                                    <div class="Input_inputContainer_lPXgf">
                                        <input class="InputField_inputField_vzhmi" name="name" placeholder="Ваше имя" type="text" value="Snow-Melon" />
                                    </div>
                                ...
                                <div class="Form_standard_f_1gD">
                                    <div class="Input_container_M2APT">
                                        ...
                                        <div class="Input_inputContainer_lPXgf"><input class="InputField_inputField_vzhmi" disabled="" name="email" placeholder="Ваша почта" type="text" value="mr.kozlov.09@gmail.com" /><div class="Input_rightElement_UfudP"><button class="InlineButton_inlineBtn_YwyQe" type="button">Изменить</button></div></div>
