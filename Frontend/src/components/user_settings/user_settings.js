...
export default function User_Settings(props) {
  return (
    <body class="us_body">
          ...
          <div class="Settings_wrapper_GH7yH">
            <aside class="Settings_menu_FKyWy">
              <nav class="AsideTabs_wrapper__I8NM">
                <a
                  id="profile"
                  class="TabItem_container_VSqU9 undefined TabItem_active_lXfvy active"
                  href="/app/settings/edit"
                  aria-current="page"
                >
                  <span class="Icon_block_Hvwi5 TabItem_icon_FVk_2"></span>
                  Профиль
                </a>
                <a
                  id="privacy"
                  class="TabItem_container_VSqU9"
              ...
              <div class="SettingsEdit_container_ycz84">
                <form class="SettingsEdit_form_EEYht">
                  <div class="SettingsEdit_photoBlock_iom21">
                    <div class="SettingsEdit_blockTitle_lMypl">
                      Фотография профиля
                    </div>
                    <div class="SettingsEdit_photoFieldContainer_rHg3Z">
                      <div class="SettingsEditPhotoField_photo_DEj6F">
                        <div
                          class="SettingsEditPhotoPreview_centredBox_mNKUc"
                          style="width: 225px; height: 280px;"
                        >
                          <img
                            class="SettingsEditPhotoPreview_image_NVmL8"
                      ...
                      <div class="SettingsEditPhotoField_upload_OiNqw">
                          ...
                          <div class="CirclesAnimation_wrapper_BLZ9e">
                            <div class="CirclesAnimation_content_Dfcn9">
                              <div class="FileButton_container_S5fmr">
                                <label
                                  for="myFile"
                                  class="FileButton_label_wRR_W"
                                >
                                  <input
                                    accept="image/*"
                                    class="FileButton_input__fX_o"
                                    id="myFile"
                                    name="photo"
                                    type="file"
                                  />
                                  <span class="Icon_block_Hvwi5 FileButton_icon_Owzfl"></span>
                                  <span class="FileButton_text_sAKVP">
                                    Выбрать файл
                                  </span>
                                </label>
                              </div>
                        ...
                        <div class="FileDescription_container__GxKK SettingsEditPhotoField_fileDescription_Wfpmg">
                  ...
                  <div class="Form_standard_f_1gD">
                    ...
                    <div class="Input_inputContainer_lPXgf">
                      <input
                        class="InputField_inputField_vzhmi"
                        name="name"
                    ...
                    <div class="Input_descriptionBottomCaption_Nh7D_">
                      <span>Имя будет показываться на вашей странице</span>
                    </div>
                  </div>
                  <div class="Form_standard_f_1gD">
                    <span class="SettingsEditPhoneField_label_VrC8H">
                      Номер телефона
                    </span>
                    <div class="SettingsEditPhoneField_container_T4BnJ">
                      <button
                        type="button"
                        name="phone"
                        class="LinkButton_button_LwwDl SettingsEditPhoneField_button_uwOfF"
                      >
                        <span class="Icon_block_Hvwi5 SettingsEditPhoneField_icon_oVqRB"></span>
                  ...
                  <div class="Form_standard_f_1gD">
                    <div class="Input_container_M2APT">
                      ...
                      <div class="Input_inputContainer_lPXgf">
                        ...
                        />
                        <div class="Input_rightElement_UfudP">
                          <button
                            class="InlineButton_inlineBtn_YwyQe"
                            type="button"
                          >
                            Изменить
                          </button>
